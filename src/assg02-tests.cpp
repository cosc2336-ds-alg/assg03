 ...
 * @brief Unit tests for Assignment 02, practice with classes and dynamic
 *   memory allocation.
 *
 * @author Derek Harter
 ...
 * @date   June 1, 2021
 *
 * Practice with classes and dynamic memory allocation.  In this *   assignment
 * we build a class to represent a large integer.  We use *   dynamic memory
 * allocation to manage an array of digits for the *   LargeInteger object.
 * This file is a set of unit tests of the LargeInteger *   class using the
